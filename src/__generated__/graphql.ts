...
export enum ChatListQueryDirection {
  After = 'After',
  Before = 'Before'
}
...
export enum MessageListQueryDirection {
  After = 'After',
  Before = 'Before'
}
...
export type Mutation = {
   ...
   * @deprecated The inbox feature is currently in preview and not stable
   */
  advanceReadMessageOffset: UnreadMessagesCount;
...
export type QueryChatsArgs = {
  direction?: InputMaybe<ChatListQueryDirection>;
  limit: Scalars['Int']['input'];
...
export type QueryMessagesArgs = {
  ...
  chatId: Scalars['String']['input'];
  direction: MessageListQueryDirection;
...
export type TokensQuery = { __typename?: 'Query', tokens: { __typename?: 'AuthToken', accessToken: string, network?: { __typename?: 'Network', name: string } | null, role: { __typename: 'Role', name: string, scopes: Array<string> }, member: { __typename: 'Member', id: string, name?: string | null } } };
